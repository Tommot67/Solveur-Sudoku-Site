    ...
    class resolveur
    {
        static void Main()
        {
            ...
            try
            {
                ...
                //appel procedure d'affichage de la grille (complete)
                var sudoku_complet = resolveurComplet(sudoku);
                affichetab(sudoku_complet);
                //appel de la procedure d'ecriture des tableaux dans le html avec le paramétre de la grille (base , partielle , complet)
                ////html.entre_tab(sudoku_complet, "partielle"); //permet le bon fonctionnement du css . Uilisé unique pour la V2.
                ////html.entre_tab(sudoku_complet, "complet");
